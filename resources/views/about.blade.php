...
<html lang="en">
    <head>
        ...
        <title>Your Indian Shop - About</title>
            ...
            <header class="site-header section-padding-img site-header-image">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12 header-info">
                            <h1>
                                <span class="d-block text-primary">Your</span>
                                <span class="d-block text-dark">Indian Shop</span>
                                <p class="mt-5">We cater to Indians abroad and enthusiasts of Indian culture, simplifying online shopping from Indian stores. Whether longing for home flavors or drawn to India's offerings, we're your solution. Bridging international shipping barriers, we make accessing desired Indian products hassle-free, turning dreams into reality in just a click..</p>
                            </h1>
                        </div>
                    </div>
                </div>
